...
static const std::string Decompress(size_t Size)
{
  ...
  while (Input_position / 8 < Size - 1)
  {
    ...
    cout << "New=" << New << "\n";
    std:cout << "Code_table.size()=" << Code_table.size() << "\n";
    std::string Symbols;
...
int main()
{
  ...
  char *Parameters[3] = {"sb", "C:/Users/ylxiao/workspace/project_3_decoder/src/Input.bin", "C:/Users/ylxiao/workspace/project_3_decoder/src/Output.bin"};
